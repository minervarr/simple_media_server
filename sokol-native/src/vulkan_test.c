/*
 * Vulkan Autonomous Test - No Window Required
 *
 * This test validates all Vulkan functionality without requiring
 * a graphical environment. Perfect for CI/headless testing.
 */
...
bool test_create_instance(VkInstance* instance) {
    ...
    VkApplicationInfo app_info = {
        ...
        .pApplicationName = "Autonomous Vulkan Test",
...
int main(int argc, char** argv) {
    ...
    printf("\n");
    printf("═══════════════════════════════════════════════════════════\n");
    printf("  VULKAN AUTONOMOUS TEST SUITE\n");
    printf("  Headless validation of all Vulkan functionality\n");
    printf("═══════════════════════════════════════════════════════════\n");
    printf("\n");
